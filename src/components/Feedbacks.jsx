...
const FeedbackCard = ({
  ...
  >
    ...
    <div className='mt-1 xs:mt-0'>
      <p className='text-white tracking-wider text-[18px] text-justify'>{testimonial}</p>
...
const Feedbacks = () => {
  return (
    <div className={`bg-black-100 rounded-[20px]`}>
      ...
      <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap justify-center gap-7 xs:-mt-30`}>
